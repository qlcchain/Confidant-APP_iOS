...
/// Returns:
/// string : public key
+ (void)getAccountPublicKey:(NSString *)baseUrl address:(NSString *)address successHandler:(void(^_Nonnull)(NSArray * _Nullable responseObj))successHandler failureHandler:(void(^_Nonnull)(NSError * _Nullable error, NSString *_Nullable message))failureHandler;
