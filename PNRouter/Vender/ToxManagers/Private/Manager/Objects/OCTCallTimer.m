    ...
    @synchronized(self) {
        ...
        dispatch_source_set_event_handler(self.timer, ^{
            ...
            if (! strongSelf) {
                ...
                NSLog(@"Error: Attempt to update timer with no strong pointer to OCTCallTimer");
                return;
            }
            ...
            NSLog(@"Call: %@ duration at %f seconds", strongSelf.call, strongSelf.call.callDuration);
        });
...
- (void)stopTimer
{
    @synchronized(self) {
        ...
        NSLog(@"Timer for call %@ has stopped at duration %f", self.call, self.call.callDuration);
