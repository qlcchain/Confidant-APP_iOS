...
class Base58Util: NSObject {
   ...
   @objc static func Base58Encode(codeName:String) -> String {
...
//        return decodeStr
    ...
    @objc static func Base58EncodeDataToStr(data:Data) -> String {
        return  Base58.encode(data)
    }
    
    @objc static func Base58DecodeStrToData(str:String) -> Data? {
